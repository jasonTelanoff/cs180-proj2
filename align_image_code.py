...
def rescale_images(im1, im2, pts):
    ...
    if dscale < 1:
        im1 = sktr.rescale(
            im1, (dscale, dscale, 1)
        )  # should be same as passing multichannel=True
    else:
        im2 = sktr.rescale(im2, (1.0 / dscale, 1.0 / dscale, 1))
    return im1, im2
...
if __name__ == "__main__":
    ...
    im2 = plt.imread("hybrid_python/DerekPicture.jpg")
    im1 = plt.imread("hybrid_python/nutmeg.jpg")
